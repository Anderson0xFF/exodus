...
//             Token::CHAR_T => "char".to_string(),
//             Token::String => "string".to_string(),
//             Token::IDENT(v) => v.to_string(),
//             Token::INT8_T => "int8_t".to_string(),
//             Token::INT16_T => "int16_t".to_string(),
//             Token::INT32_T => "int32_t".to_string(),
//             Token::INT64_T => "int64_t".to_string(),
//             Token::UINT8_T => "uint8_t".to_string(),
//             Token::UINT16_T => "uint16_t".to_string(),
//             Token::UINT32_T => "uint32_t".to_string(),
//             Token::UINT64_T => "uint64_t".to_string(),
//             Token::FLOAT64_T => "f64_t".to_string(),
